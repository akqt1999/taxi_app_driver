...
import 'package:taxi_app_flutter/locators/service_locator.dart';
...
//                            topRight: Radius.circular(20)),
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  leading: Container(
                    child:appState.riderModel.phone  == null ?  const CircleAvatar(
                      radius: 30,
                      child: Icon(Icons.person_outline, size: 25,),
                    ) : CircleAvatar(
                      radius: 30,
                      backgroundImage: NetworkImage(appState.riderModel.phone??""),
                    ),
                  ),
                  title: Row(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: CustomText(
                      text: "Cancel Ride",
                      color: white, weight: FontWeight.normal, size: 20,
                    ),
                  ),
                )
              ],
