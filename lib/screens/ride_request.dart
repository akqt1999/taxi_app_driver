...
import 'package:taxi_app_flutter/helpers/stars_method.dart';
...
import 'package:taxi_app_flutter/widgets/custom_btn.dart';
          ...
          body: Container(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                stars(
                    rating: appState.riderModel.rating??0, // dấu ?? nghĩa là nếu nó khác null thì nó sẽ đc sử dụng ngưược lại thì nó sẽ sử dụng cái ở phía sau
                    ...
                    CustomBtn(
                      ...
                      onTap: () async {
                        if (appState.requestModelFirebase.status != "pending") {
                          ...
                          appState.sendRequest(coordinates: appState.requestModelFirebase.getCoordinates(), intendedLocation: '');
//                      showDialog(
//                          context: context,
//                          builder: (BuildContext context) {
//                            return Dialog(
